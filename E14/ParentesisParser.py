...
class ParentesisParser ( Parser ):
    ...
    class ExprContext(ParserRuleContext):
        ...
        def term(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(ParentesisParser.TermContext)
            else:
                return self.getTypedRuleContext(ParentesisParser.TermContext,i)


        def getRuleIndex(self):
            return ParentesisParser.RULE_expr
    ...
    def expr(self):
        ...
        localctx = ParentesisParser.ExprContext(self, self._ctx, self.state)
    ...
    class TermContext(ParserRuleContext):
        ...
        def factor(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(ParentesisParser.FactorContext)
            else:
                return self.getTypedRuleContext(ParentesisParser.FactorContext,i)


        def getRuleIndex(self):
            return ParentesisParser.RULE_term
    ...
    def term(self):
        ...
        localctx = ParentesisParser.TermContext(self, self._ctx, self.state)
    ...
    class FactorContext(ParserRuleContext):
        ...
        def NUM(self):
            return self.getToken(ParentesisParser.NUM, 0)

        def expr(self):
            return self.getTypedRuleContext(ParentesisParser.ExprContext,0)


        def getRuleIndex(self):
            return ParentesisParser.RULE_factor
    ...
    def factor(self):
        ...
        localctx = ParentesisParser.FactorContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if token in [7]:
                self.enterOuterAlt(localctx, 1)
                self.state = 22
                self.match(ParentesisParser.NUM)
                pass
            elif token in [5]:
                self.enterOuterAlt(localctx, 2)
                self.state = 23
                self.match(ParentesisParser.T__4)
                self.state = 24
                self.expr()
                self.state = 25
                self.match(ParentesisParser.T__5)
                pass
            else:
